...
em++ -std=c++17 -Wall -Wextra -pedantic -O3 -ffast-math -flto -fno-rtti -fno-exceptions --closure 1 -s EXPORTED_FUNCTIONS='["_runTest"]' -s WASM_ASYNC_COMPILATION=0 -s DYNAMIC_EXECUTION=0 -s FILESYSTEM=0 -s EXIT_RUNTIME=0 -s ASSERTIONS=0 -s MODULARIZE=1 -s ENVIRONMENT='worker' -o WasmTest.js ./CPU-test.cpp -lm
